...
const envSchema = z.object({
  ...
  AUTH_BOOTSTRAP_USERNAME: optionalSecret,
  AUTH_BOOTSTRAP_PASSWORD: optionalSecret,
  AUTH_BOOTSTRAP_PASSWORD_B64: optionalSecret,
  AUTH_BOOTSTRAP_SYNC_PASSWORD: z.enum(["true", "false"]).default("false"),
  AUTH_SESSION_DAYS: z.coerce.number().int().positive().default(30),
  AUTH_COOKIE_SECURE: z.enum(["true", "false"]).default("false"),
  EMAIL_VERIFICATION_HOURS: z.coerce.number().int().positive().default(24),
