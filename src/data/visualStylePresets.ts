export const visualStylePresets = [
  {
    id: "suspense-guoman",
    thumbnail: "/style-thumbnails/suspense-guoman.svg",
    label: "悬疑国漫",
    sub: "冷蓝灰 / 强线稿",
  ...
  {
    id: "cinematic-real",
    thumbnail: "/style-thumbnails/cinematic-real.svg",
    label: "写实剧照",
    sub: "电影感 / 克制光影",
  ...
  {
    id: "gritty-comic",
    thumbnail: "/style-thumbnails/gritty-comic.svg",
    label: "粗粝漫画",
    sub: "颗粒 / 厚重笔触",
  ...
  {
    id: "noir-manga",
    thumbnail: "/style-thumbnails/noir-manga.svg",
    label: "黑白硬线漫画",
    sub: "高反差 / 阴影切割",
  ...
  {
    id: "urban-anime",
    thumbnail: "/style-thumbnails/urban-anime.svg",
    label: "都市动画",
    sub: "清晰色块 / 夜景",
  ...
  {
    id: "ink-wuxia",
    thumbnail: "/style-thumbnails/ink-wuxia.svg",
    label: "水墨武侠",
    sub: "留白 / 墨色层次",
  ...
  {
    id: "soft-shojo",
    thumbnail: "/style-thumbnails/soft-shojo.svg",
    label: "柔光漫感",
    sub: "细腻 / 情绪氛围",
  ...
  {
    id: "cyber-comic",
    thumbnail: "/style-thumbnails/cyber-comic.svg",
    label: "赛博霓虹",
    sub: "电子光 / 高密度",
  ...
  {
    id: "heroic-comic",
    thumbnail: "/style-thumbnails/heroic-comic.svg",
    label: "美式英雄",
    sub: "力量感 / 动态构图",
  ...
  {
    id: "stylized-3d",
    thumbnail: "/style-thumbnails/stylized-3d.svg",
    label: "卡通 3D",
    sub: "体块 / 柔和材质",
  ...
  {
    id: "minimal-line",
    thumbnail: "/style-thumbnails/minimal-line.svg",
    label: "极简线稿",
    sub: "少色 / 留白",
  ...
  {
    id: "retro-film",
    thumbnail: "/style-thumbnails/retro-film.svg",
    label: "复古胶片",
    sub: "旧电影 / 暖暗部",
